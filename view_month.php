...
<title>:: FRSC :: Monthly Logbook Record</title>
...
<?php 
  ...
  <p>&nbsp;</p>
  <h1>Month of <?php echo date("F");?> Visitors Log</h1>
  
  <?php
//SQL query to pull out all registered students
$fetch="SELECT * FROM `logbook` WHERE MONTH(`date`)=MONTH(NOW()) AND YEAR(`date`)=YEAR(NOW())  ORDER BY `timein` ASC LIMIT $start, $display ";
